...
check(HistoryChartPolicy.closerZoom(than: 3600) == 60, "1 hour closes to 1 minute")
check(HistoryChartPolicy.closerZoom(than: 60) == 60, "1 minute is the closest range")
