...
charge.observeLevel(60); charge.observeLevel(62)
check(charge.isCharging, "battery rise of 2% infers charging")
charge.observeLevel(60)
check(!charge.isCharging, "battery fall clears charging")
var flicker = WearableChargePolicy()
flicker.observeLevel(58); flicker.observeLevel(59)
check(!flicker.isCharging, "a 1% flicker is not charging")
flicker.observeLevel(60)
check(flicker.isCharging, "a continued rise from the same anchor is charging")
